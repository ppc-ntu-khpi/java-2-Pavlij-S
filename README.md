[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=24097438)
...
## Обране завдання
Завдання 13: Зашифрувати задану фразу шифром Цезаря з заданою величиною зсуву N.

У реалізації метод ```Exercise.Calculate(String phrase, int shift)``` приймає текст та величину зсуву і повертає зашифрований рядок. Літери латинського алфавіту зсуваються з урахуванням регістру, пробіли та символи, що не є буквами, залишаються без змін.
